...
-   [25 min] **Revisión:** HW3
    ...
    > -  ¿Propósito [Factory Method](https://cgranell.github.io/ei1039/slides/TE3_2_factory.html#25)?  Una abstracción define un método de creación común, pero las subclases pueden modifican los objetos creados. Método de creación unificada, pero objetos resultados distintos.
