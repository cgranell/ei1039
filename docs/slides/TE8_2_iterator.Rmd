...
## proporciona una forma de acceder a un objeto agregado .coldinline[sin exponer su estructura interna]
...
- .large[Iteración `r fontawesome::fa(name = "equal")` repetición, implementado como recursión o bucles. El patrón Iterator implementa dicha iteración sobre arrays, vectores, árboles, u otros tipos de colecciones. Java está lleno de Iterators...]

---
# Iterator: Aplicabilidad

.large[`r fontawesome::fa(name = "arrow-circle-right")` cuando queremos encapsular la estructura de datos de una colección y propporcionar a cambio método para recorrer la colección]

--

.large[`r fontawesome::fa(name = "arrow-circle-right")` cuando queremos reducir el codigo relacia a recorrer colecciones]
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` contibuye a la reutilzacion de código, permitiendo acceder a elementos de una colección sin comprometer su estructura interna]
