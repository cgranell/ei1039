...
> 3. .large[Delega la implementación de los métodos de la clase `Facade` al subsistema]
...
## ¿Qué dos condiciones se requieren para usar un patrón `Facade`?
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` Cuando necesitas disponer de un único objeto que representa un subsistema completo]
...
## ¿Qué principios definen la implementaion del patrón `Facade`?
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` TODO]
