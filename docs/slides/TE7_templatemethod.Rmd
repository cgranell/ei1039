...
---
# `r fontawesome::fa(name = "circle-question")` Elige el diagrama UML correcto según lo descrito al presionar `p`

???

El nombre de un método de plantilla para una clase de vehículos autónomos podría ser conducir hasta el destino (`drivetoDestination()`. Tanto un automóvil autónomo como una motocicleta requieren  de una función para llegar a su destino (`reachDestination()`)
