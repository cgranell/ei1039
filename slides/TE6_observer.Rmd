...
Una estructura alternativa para el Sujeto es declarar una interfaz y luego implementar un Sujeto Concreto. La relació de composición ocurre entre el Sujeto y Observador Concreto.


---
# Observer: Aplicabilidad

.large[`r fontawesome::fa(name = "arrow-circle-right")` cuando los cambios en el estado de un objeto conllevan cambios en un grupo dinámico de objetos]

--

.large[`r fontawesome::fa(name = "arrow-circle-right")` cuando algunos objetos de tu aplicación
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` permite que varios objetos (observadores) se _suscriban_ a un objeto (observado)]
 
.large[`r fontawesome::fa(name = "arrow-circle-right")` permite que el objeto observado notifique a los objetos observados cuando cambia su estado]
