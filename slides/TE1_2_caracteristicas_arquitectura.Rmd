...
- .large[Elasticity/Elasticidad]: Capacidad para getionar picos masivos de usuarios/solicitudes
]
...
# ¿Cómo separo las que son relevantes de las que no lo son?
...
Example from `r Cite(my_refs, "richards2020")` on page 69
