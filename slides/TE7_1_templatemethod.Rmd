...
## define los .coldinline[pasos de un algoritmo] en la superclase y delega a las subclases la implementación de algunos de estos pasos
...
### Un _template method_ encapsula (generaliza) los pasos de un algoritmo en una clase `abstract`

### Differencia entre pasos comunes y que necesitan especialización

### La clase abstracta tiene un (`final`) método que describe los pasos del algoritmo (plantilla) 

- .large[Los pasos comunes se implementan en la superclase]

- .large[Los pasos que requieren especialización, se definen como abstractos en la superclase y se implementan en las subclases]
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` cuando tenemos algoritmos con secuencias de pasos predefinidas]
...
.large[`r fontawesome::fa(name = "arrow-circle-right")` crea un _plantilla_ genérica de un algoritmo]

.large[`r fontawesome::fa(name = "arrow-circle-right")` define esa _plantilla_ como un método `final` en la superclase]

.large[`r fontawesome::fa(name = "arrow-circle-right")` define (en la superclase) métodos `abstract` para pasos que necesitan especialización]
 
.large[`r fontawesome::fa(name = "arrow-circle-right")` implementa (en la superclase) primativas comunes]

.large[`r fontawesome::fa(name = "arrow-circle-right")` define (en la superclase) ganchos (_hooks_) para pasos opcionales o extensiones del algoritmo]
