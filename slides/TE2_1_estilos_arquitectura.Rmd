...
## como se estructura o organiza todo el backend e interfaces de usuario.
...
- .large[_Plug-ins_ independientes, encapsulados y _standalone_, que se comunican con el sistema (REST, pipe, ...)]
...
Plug-ins son componentes independientes, _standalone_ que propof funcioanl adicional al  meant to enhance or extend the core system
