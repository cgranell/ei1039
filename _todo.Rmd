...
-   Reestructurar la web como el curso de RRP. Añadir estilos como en https://emitanaka.org/ y https://jhelvy.github.io/distillery/showcase.html. ¿Alguna forma de comunicar los patrones de diseño o su aplicación como una documento dinámico, al estilo de https://distill.pub/2020/communicating-with-interactive-articles/? ¿Podria ser un ejercicio a los alumnos?

-   Trasladar a la docencia los avances científicos más reciente en diseño de patrones. Eliminar algunas actividades POGIL (un par, por ejemplo) para utilizar  sesiones magistrales de avances, novedades y tendencias mas recientes. No es necesario que sean seguidads. 
...
- ¿Son las actividades POGIL necesarioas en todas las clases?
...
-   Encontrar modo de corregir y proporcionar feedback a los HW y actividades POGIL. Por ejempñlo, los howeworks se puede realziar todos en Guithub, con una estructura dada (ejemplo de repo mio), que combine ficheros readme y codigo. Los ficheros readme pueden incluir refelxiones tambien.  

-   Nombrar (name) las slides clave de cada presentacion: inicio, estructura, participantes
...
- Seminario de presentacion publica
https://aenui.org/actas/pdf/JENUI_2019_019.pdf
https://aenui.org/actas/pdf/JENUI_2013_002.pdf
https://aenui.org/actas/pdf/JENUI_2011_025.pdf
