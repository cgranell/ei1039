...
-   Modifcar la descricpon del proyecto para que quede mucho mas claro cuales son las actividades a realizar por parte de la EI1039. Por ejemplo, que los estudiante justifiquen (¿como?, seguir ejemplo de Ernest...) el uso de patrones que implementan, pero tambien que identifiquen patrones que utilizan de forma indirectas por las distitnas herramientas qeu utli, u otros potenciales patrones en la reservars. MInimo 3 patrones individauels, o 2 si uno de ellos es compuesto. 
