...
Tan imporante como los resultaods de aprendizaje anteriores son las competencias blandas (o *soft skills*) como la habilidad de comunicación, trabajo en equipo, sintetizar información, capacidad de toma de decisiones y resolución de conflictos, gestión de tiempo o liderazgo. Trabajaremos estas competencias blandas a lo largo del curso pues, lo creas o no, son aspectos vitales en el día a día de un arquitecto/a de software.
...
+----------------------------------------------+------------+------+-----------------------------------------------+
| Trabajo no presencial                        | Individual | 15%  | Código                                        |
+----------------------------------------------+------------+------+-----------------------------------------------+
...
+----------------------------------------------+------------+------+-----------------------------------------------+
| Proyecto común (con EI1048)                  | Grupo      | 60%  | Codigo, documento escrito y presentación      |
+----------------------------------------------+------------+------+-----------------------------------------------+
